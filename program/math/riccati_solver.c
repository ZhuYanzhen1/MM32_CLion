...
//    yaw_error = 0.9f * yaw_error;
    ...
    if ((playground_ind < 160) || (playground_ind > 450 && playground_ind < 840) || (playground_ind > 1120))
        control_val[1][0] /= 2;
    else if ((playground_ind < 200 && playground_ind > 160) || (playground_ind > 840 && playground_ind < 880))
