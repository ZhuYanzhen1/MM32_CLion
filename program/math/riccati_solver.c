...
//    yaw_error = 0.9f * yaw_error;
    ...
    if ((playground_ind < 100) || (playground_ind > 260 && playground_ind < 430) || (playground_ind > 620))
        control_val[1][0] /= 2;
    else if ((playground_ind < 130 && playground_ind > 100) || (playground_ind > 430 && playground_ind < 450)
        || (playground_ind > 200 && playground_ind < 260))
