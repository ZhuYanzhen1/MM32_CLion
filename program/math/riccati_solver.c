...
float calculate_distance(int ind) {
    ...
    float distance = sqrtf(
            ((reference_point_test[ind][0] - distance_north) * (reference_point_test[ind][0] - distance_north)
             + (reference_point_test[ind][1] - distance_east) * (reference_point_test[ind][1] - distance_east)));
    return distance;
}
