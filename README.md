...
+ program: Program source files and configuration files.
  ...
  + debug: Data link layer and transport layer code used to implement serial port debug parameters.
  + device: Device specific data link layer protocol for device level register reading and writing.
