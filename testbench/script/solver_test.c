...
void test_riccati_solver(void) {
    ...
    double x_error = status.pos_n - 4305.411;    // 4305.4110000f, 39632.8750000f, 3.1414113f, 0.0001956f
    double y_error = status.pos_e - 39632.875;
    double yaw_error = yaw_temp - 3.1414113;
    if (yaw_error > 3.14)
        yaw_error -= _2PI_;
    else if (yaw_error < -3.14)
        yaw_error += _2PI_;

    double v_r = 4, dt = 0.04f, fai_r = 3.1414113, delta_r = 0.0001956, L = 0.28;
